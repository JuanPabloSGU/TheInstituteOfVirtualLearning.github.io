...
import {Container, Row, Col, Button, ListGroup, Card, Modal, Form} from 'react-bootstrap';
            ...
            <section className="p-3">
                <Container>
                    <Row>
                        ...
                        <Col>
                            <img src='./InstituteVirtual.github.io/assets/tutorBrandon.jpg'></img>
                        </Col>
...
function QuoteModalCentered(props) {
    ...
    const BrandoneFee = 50;

    var total = flatrate + BrandoneFee;
        ...
        <>
            <section className="bg-dark text-white">
                <Container className="p-3">
                    <h4 className="text-center py-3">Brandon is avaliable for a consultation</h4>
                    <Row className="pb-4">
                        <Col>
                            <Card className="text-black">
                                <Card.Body>
                                    <Card.Title as={"h5"} className="text-center">
                                        Obtain Quote for Brandon as a tutor
                                    </Card.Title>
